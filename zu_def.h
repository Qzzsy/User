...
typedef signed   char                   zu_int8_t;      /**<  8bit integer type */
typedef signed   short                  zu_int16_t;     /**< 16bit integer type */
typedef signed   long                   zu_int32_t;     /**< 32bit integer type */
typedef unsigned char                   zu_uint8_t;     /**<  8bit unsigned integer type */
typedef unsigned short                  zu_uint16_t;    /**< 16bit unsigned integer type */
typedef unsigned long                   zu_uint32_t;    /**< 32bit unsigned integer type */
typedef int                             zu_bool_t;      /**< boolean type */

/* 32bit CPU */
typedef long                            zu_base_t;      /**< Nbit CPU related date type */
typedef unsigned long                   zu_ubase_t;     /**< Nbit unsigned CPU related data type */

typedef zu_base_t                       zu_err_t;       /**< Type for error number */
typedef zu_uint32_t                     zu_time_t;      /**< Type for time stamp */
typedef zu_uint32_t                     zu_tick_t;      /**< Type for tick count */
typedef zu_base_t                       zu_flag_t;      /**< Type for flags */
typedef zu_ubase_t                      zu_size_t;      /**< Type for size number */
typedef zu_ubase_t                      zu_dev_t;       /**< Type for device */
typedef zu_base_t                       zu_off_t;       /**< Type for offset */
...
#define ZU_EOK                          0               /**< There is no error */
#define ZU_ERROR                        1               /**< A generic error happens */
...
#define ZU_EINVAL                       10              /**< Invalid argument */

#define ZU_ENABLE                       (1 << 0)
#define ZU_DISABLE                      (1 << 1)
/**
