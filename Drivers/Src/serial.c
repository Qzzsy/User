...
//static zu_err_t serial_fops_rx_ind(zu_device_t dev, zu_size_t size)
//{
 ...
 * Serial DMA routines
 */
zu_inline int _serial_dma_rx(struct rt_serial_device *serial, zu_uint8_t *data, int length)
{
    rt_base_t level;
